Tool = {
   ...
   * 保存登录用户信息
   */
  setLoginMember: function (loginUser) {
    SessionStorage.set(SESSION_KEY_LOGIN_MEMBER, loginUser);
  },
  /**
   * 保存登录用户信息
   */
  removeLoginUser: function () {
    SessionStorage.remove(SESSION_KEY_LOGIN_MEMBER);
  },
  /**
   * 获取登录用户信息
   */
  ...
  hasResource: function (id) {
    let _this = this;
    let resources = _this.getLoginMember().resources;
